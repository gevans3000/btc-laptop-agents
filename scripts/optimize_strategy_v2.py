...
def main():
    ...
    if results:
        ...
        opt_config["setups"]["pullback_ribbon"]["stop_atr_mult"] = winner["params"]["stop"]
        opt_config["setups"]["pullback_ribbon"]["tp_r_mult"] = winner["params"]["tp"]
        opt_config["setups"]["pullback_ribbon"]["entry_band_pct"] = winner["params"]["band"]
        opt_config["setups"]["sweep_invalidation"]["stop_atr_mult"] = winner["params"]["stop"] * 0.4
