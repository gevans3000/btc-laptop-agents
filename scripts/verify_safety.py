...
def test_paper_broker_equity():
    ...
    broker.pos = Position(side="LONG", entry=50.0, qty=1.0, sl=40.0, tp=60.0, opened_at="t1")
    ...
    broker.pos = Position(side="SHORT", entry=50.0, qty=1.0, sl=60.0, tp=40.0, opened_at="t1")
...
def test_supervisor_rounding():
    ...
    # Minimal mock
    supervisor = Supervisor(provider=None, cfg={"derivatives_gates":{}, "setups":{}, "risk":{}}, journal_path="temp_journal.jsonl")
