...
## MVP Control Surface - 5 Key Commands

These 5 commands provide complete control over the paper trading system:
...
### Data Sources
- Mock data generator (no external dependencies)
- Bitunix futures API (requires configuration)
