...
MAX_POSITION_SIZE_USD = 500.0  # Absolute max for any single trade
MAX_POSITION_ABS = 1.0  # Absolute max for any single position
...
MAX_LEVERAGE = 1.0  # Match user's manual settings
